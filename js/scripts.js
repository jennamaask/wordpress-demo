...
// the following code was take from https://dev.to/link2twenty/accessibility-first-tabs-ken to make accesible tabs
class TabController {
...
const tabController = new TabController('.tabbed-content');